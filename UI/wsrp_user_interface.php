...
$postID = $post_id->ID;
 ?>
<div id="wsrp_shortcode">
  <p >Use this shortcode <b>[wsrp_rating id="<?php echo $postID; ?>"]</b></p>
  <p> For support or reporting bugs visit  : <a href="http://web-settler.com/ulp-support/"> <b>Support Form</b></a></p>
</div>
            ...
            <tr valign="top">
             ...
             <tr valign="top">
              ...
              <td><label for="wsrp_rating_max_value">
                  <input type='range' step='5'  id='wsrp_rating_max_value' name='wsrp_rating_max_value' min='0'  max='5' value='<?php echo get_post_meta(
                  $postID ,'wsrp_rating_max_value',true); ?>' oninput="this.form.amountInput1.value=this.value" /> <input type="number"  name="amountInput1" min="0" max="5" value='<?php echo get_post_meta($postID ,'wsrp_rating_max_value',true); ?>' size='5' oninput="this.form.wsrp_rating_max_value.value=this.value" />
              ...
              <td><label for="wsrp_rating_initial_value">
                  <input type='range' step='1'  id='wsrp_rating_initial_value' name='wsrp_rating_initial_value' min='0'  max='10' value='<?php echo get_post_meta($postID ,'wsrp_rating_initial_value',true); ?>' oninput="this.form.amountInput2.value=this.value" /> <input type="number"  name="amountInput2" min="0" max="10" value='<?php echo get_post_meta($postID ,'wsrp_rating_initial_value',true ); ?>' size='1' oninput="this.form.wsrp_rating_initial_value.value=this.value" />
         ...
         <tr valign='top'>
            ...
            <td>
              ...
              <div id="left">
                ...
                <div  class="wsrp-mox">
              <p class="pp"style='padding:0px 0px 0px 20px ;'>Layout 1 Default <input type="radio" name="wsrp_rating_layout" id="layout" value="layout" <?php  checked('layout', get_post_meta($postID,'wsrp_rating_layout',true)); true ?> /></p> 
              ...
              <div  class="wsrp-mox">
              <p class="pp"style='padding:0px 0px 0px 20px ;'>Layout 2  Premium <a href="http://web-settler.com/wp-rating/" target="_blank">Premium Only </a> </p> <input type="radio"  name="wsrp_rating_layout" id="layout2" disabled /></p>
              ...
              <p class="pp"style='padding:0px 0px 0px 20px ;'>Layout 4  Premium <a href="http://web-settler.com/wp-rating/" target="_blank">Premium Only </a> <input type="radio"   name="wsrp_rating_layout" id="layout4" disabled /></p>
              ...
              <div  class="wsrp-mox">
              <p class="pp"style='padding:0px 0px 0px 20px ;'>Layout 6  Premium <a href="http://web-settler.com/wp-rating/" target="_blank">Premium Only </a><input type="radio"   name="wsrp_rating_layout" id="layout6" disabled /></p>
              ...
              <div id="right">
                ...
                <div  class="wsrp-mox">
              <p class="pp"style='padding:0px 0px 0px 20px ;'>Layout 1  Premium <a href="http://web-settler.com/wp-rating/" target="_blank">Premium Only </a> <input type="radio"  name="wsrp_rating_layout" id="layout1" disabled /> </p>
              ...
              <div  class="wsrp-mox">
              <p class="pp"style='padding:0px 0px 0px 20px ;'>Layout 3   Premium <a href="http://web-settler.com/wp-rating/" target="_blank">Premium Only </a><input type="radio"   name="wsrp_rating_layout" id="layout3" disabled /></p>
              ...
              <div  class="wsrp-mox">
              <p class="pp"style='padding:0px 0px 0px 20px ;'>Layout 5   Premium <a href="http://web-settler.com/wp-rating/" target="_blank">Premium Only </a><input type="radio"   name="wsrp_rating_layout" id="layout5" disabled /></p>
              ...
              <div  class="wsrp-mox">
              <p class="pp"style='padding:0px 0px 0px 20px ;'>Layout 7   Premium <a href="http://web-settler.com/wp-rating/" target="_blank">Premium Only </a><input type="radio"   name="wsrp_rating_layout" id="layout5" disabled /></p>
